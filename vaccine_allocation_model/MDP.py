    ...
    def _map_infection_to_response_measures(self, previous_cw, previous_flow_scale):
        if len(self.path) > 3:
            ...
            if self.verbose:
                ...
                print(f"Previous alphas: {previous_flow_scale}")
                print(f"New flow: {new_flow_scale}\n\n")
